...
TEST(Full_Enumeration,VERYHARD1) {
    double  Weight[] = {11,33,27,39,40,31,6,55,35,19,44,55,66,77,88,99,111,222,333,444,555,666,77,88,99,88};
...
TEST(Full_Enumeration,VERYHARD2) {
    double  Weight[] = {11,33,27,39,40,31,6,55,35,19,44,55,66,77,88,99,111,222,333,444,555,666,77,88,99,88,66,33};
